...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      description: "For homes or professionals who need trusted daily support.",
      icon: Briefcase,
    },
  ];
  ...
  <div className="mt-10 text-center max-w-2xl mx-auto">
    <p className="text-gray-700 text-base">
      Each placement is tailored to meet your unique needs whether{" "}
      <strong>part-time</strong>, <strong>full-time</strong>,{" "}
