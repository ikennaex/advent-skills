...
const GeneralCleaner = () => {
  const [workers, setWorkers] = useState([]);
    ...
    const getWorkers = async () => {
        setLoading(true);
        try {
        const response = await axios.get(`${baseUrl}/generalcleaner`);
    ...
    const locationMatch = locationFilter
        ...
        : true;
    const roleMatch = worker.role?.toLowerCase() === "General Cleaner";
    ...
    <div className="container mx-auto px-4 py-8">
        <h2 className="text-3xl font-bold text-center my-6">General Cleaner</h2>
        {/* Filter Section */}
